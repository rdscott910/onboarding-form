...
interface ImprovedRestaurantHoursProps {
...
const ImprovedRestaurantHours: React.FC<ImprovedRestaurantHoursProps> = ({ hours, onChange, onNext }) => {
  ...
  return (
    <div className="w-full max-w-3xl mx-auto bg-gray-800 text-white p-6 rounded-lg shadow-lg">
      <Accordion type="single" collapsible className="w-full">
        <AccordionItem value="restaurant-hours">
          <AccordionTrigger className="text-xl font-semibold">Restaurant Hours</AccordionTrigger>
          <AccordionContent>
            {daysOfWeek.map((day) => (
...
export default ImprovedRestaurantHours;
